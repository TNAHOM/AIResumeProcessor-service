...
def upload_resume(
    ...
    """
    Upload resume and enqueue for processing via Redis job queue.
    
    This endpoint now uses Redis-based job queue instead of FastAPI BackgroundTasks
    ...
    return {
        ...
        "message": "Resume accepted and is being processed via job queue.",
    }
...
def get_application_status(application_id: str, db: Session = Depends(get_db)):
    """Get the processing status of a resume application."""
